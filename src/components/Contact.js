                        ...
                        <Fade bottom>
                            <div className="bg-white shadow-md rounded-lg p-7 box-border">
                                <div className="flex flex-col justify-center items-center py-3">
                                    ...
                                    <a href="https://api.whatsapp.com/send/?phone=447985190948&text&app_absent=0" target="_blank" rel="noreferrer" className="text-decoration-none text-blue-600 text-xl hover:text-yellow-500 block text-center font-semibold">Chat On WhatsApp? Click Me</a>
                                </div>
                            </div>
                        </Fade>
